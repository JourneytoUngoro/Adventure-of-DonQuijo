...
//    [field: SerializeField, Tooltip("When target gets knockback only when its stance level is lower than threat level.")] public Intensity threatLevel { get; private set; } = Intensity.��;
