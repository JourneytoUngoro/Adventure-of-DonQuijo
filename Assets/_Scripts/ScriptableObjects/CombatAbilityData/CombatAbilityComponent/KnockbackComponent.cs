...
public enum DirectionBase { Position, Absolute, sourceEntityFacingDirection, positionRelative }
...
public class KnockbackComponent : CombatAbilityComponent
{
    ...
    [field: SerializeField] public float orthogonalVelocityWhenBlocked { get; private set; }
    ...
    [field: SerializeField] public float orthogonalVelocityWhenParried { get; private set; }
