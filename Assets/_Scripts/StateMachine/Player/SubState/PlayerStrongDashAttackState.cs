...
public class PlayerStrongDashAttackState : PlayerAbilityState
{
    public PlayerStrongDashAttackState(Player player, string animBoolName) : base(player, animBoolName)
    {
        available = true;
    }
    ...
    public override void AnimationActionTrigger(int index)
    {
        ...
        player.combat.DoAttack(player.combat.strongDashAttack[1]);
    }
