...
public class CombatAbilityEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        foreach (var component in combatAbilityData.combatAbilityComponents)
        {
            if (component.pertainedCombatAbility == null)
            {
                component.pertainedCombatAbility = combatAbilityData;
            }
        }
    }
